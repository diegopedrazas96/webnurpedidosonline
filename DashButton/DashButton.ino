...
void setup() {
  ...
  //-----Configuración de red-------//Podemos comentar si el ESP ya está configurado
    ...
    //SerialESP8266.println("AT+CWJAP=\"JOSE\",\"jose678661\"");
    SerialESP8266.println("AT+CWJAP=\"LIDER\",\"chuchachucha\"");
  ...
  if (digitalRead(9) == HIGH){
    ...
    //---------enviamos las variables al servidor---------------------
        ...
        {  
            ...
            String peticionHTTP= "GET /pedidosnur/api/pedido/pedidoDash/";
            peticionHTTP=peticionHTTP+String(DashId)+" HTTP/1.1\r\n";
            peticionHTTP=peticionHTTP+"Host: 192.168.0.107:80\r\n\r\n";
